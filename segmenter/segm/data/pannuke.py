...
PANNUKE_CATS_PATH = Path(__file__).parent / "config" / "pannuke.yml"
...
class PannukeSegmentation(BaseMMSeg):
    def __init__(self, image_size, crop_size, split, **kwargs):
        ...
        self.names, self.colors = utils.dataset_cat_description(PANNUKE_CATS_PATH)
        self.n_cls = 5
        self.ignore_label = 0
